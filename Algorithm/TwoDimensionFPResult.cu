...
void TwoDimensionFPResult::runAlgorithm(ParamsCarrier *singleTone){
    int tem1, tem2, tem3;
    double Rig, p, pinj, Tkin, LBT, w, r, mu;
...
int TwoDimensionFPResult::charcount( FILE *const fin ) {
    char buf[bufSize];
    int count = 0;
